...
var ajaxCart = {
				...
				if (this.id != undefined)
				{
					...
					if($('#'+parentId+' #cart_block dt#cart_block_product_'+ domIdProduct ).length == 0)
					{
						...
						var content =  '<dt class="hidden" id="cart_block_product_' + domIdProduct + '">';
							...
							content += '<span class="sepPanier"></span></dt>';//CHANGEMENT
	...
	updateCartEverywhere : function(jsonData) {
		...
		{
			$('.ajax_cart_product_txt_s, .ajax_cart_product_txt, .ajax_cart_total').each( function () {//CHANGEMENT
					$(this).hide();
				});
				$('.ajax_cart_quantity').text('0');//CHANGEMENT
				$('.ajax_cart_quantity').fadeIn('slow');//CHANGEMENT
