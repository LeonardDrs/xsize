	...
	<div id="titreTopVente"><h2 id="titre-boutique">NOTRE BOUTIQUE</h2></div>
			...
			<ul class="clearfix">
				<li class="first_item last_item_of_line">
					<img class ="imgTopp" src="modules/slidercostume/images/1.jpg"/>
				</li>
				<li class="item last_item_of_line">
					<img class ="imgTopp" src="modules/slidercostume/images/2.jpg"/>
				</li>
				<li class="item last_item_of_line">
					<img class ="imgTopp" src="modules/slidercostume/images/3.jpg"/>
				</li>
				<li class="item last_item_of_line">
					<img class ="imgTopp" src="modules/slidercostume/images/4.jpg"/>
				</li>

				<li class="item last_item_of_line">
					<img class ="imgTopp" src="modules/slidercostume/images/5.jpg"/>
				</li>
				<li class="item last_item_of_line">
					<img class ="imgTopp" src="modules/slidercostume/images/6.jpg"/>
				</li>
			</ul>
