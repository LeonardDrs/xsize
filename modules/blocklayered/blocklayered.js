...
function openCloseFilter()
{
	$('#layered_form span.layered_close a').live('click', function(e)
	{
		...
		{
			$('#'+$(this).attr('rel')).show();
			//$(this).css("background", "url('../../themes/xsize/img/assets/filtre_down_arrow.png') no-repeat 20px 3px;");
			$(this).addClass('fleche_bas');
			$(this).removeClass('fleche_droite');
			$(this).parent().removeClass('closed');
		}
		else
		{
			$('#'+$(this).attr('rel')).hide();
			//$(this).css("background", "url('../../themes/xsize/img/assets/arrow-right.png') no-repeat 20px 3px;");
			$(this).addClass('fleche_droite');
			$(this).removeClass('fleche_bas');
