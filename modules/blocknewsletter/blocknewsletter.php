...
class Blocknewsletter extends Module
{
 	...
 	{
 	 	if (parent::install() == false OR $this->registerHook('leftColumn') == false OR $this->registerHook('header') == false OR $this->registerHook('footer') == false OR $this->registerHook('rightColumn') == false OR $this->registerHook('footer2') == false)
 	 		return false;
