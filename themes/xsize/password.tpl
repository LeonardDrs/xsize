...
<div class="containertitle"><h1 id="mdptitle">{l s='Forgot your password'}</h1></div>
...
<div class="blockblanc">
	...
	{else}
	<p id="mdprappel">{l s='Please enter the e-mail address used to register. We will e-mail you your new password.'}</p>
	<form action="{$request_uri|escape:'htmlall':'UTF-8'}" method="post" class="std">
		<fieldset class="mdpfieldset">
			<p class="text">
	...
	<hr />
	<p class="clear">
		<a href="{$link->getPageLink('authentication.php', true)}" title="{l s='Return to Login'}"><img src="{$img_dir}assets/account.png" alt="{l s='Return to Login'}" class="icon" /></a><a id="backtologin" href="{$link->getPageLink('authentication.php')}" title="{l s='Back to Login'}">{l s='Back to Login'}</a>
	</p>
</div>
